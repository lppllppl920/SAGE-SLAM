    ...
    else
    {
      ...
      while (goon)
      {
        ...
        else
        {
          ...
          const float mismatch_rate = (float)mismatch_count / (float)current_association.size();
          if (mismatch_rate < 1.0e-3)
          {
            goon = false;
          } else {
            goon = true;
          ...
          std::cout << "level " << current_level << " mismatch rate: " << mismatch_rate << std::endl;
        }
