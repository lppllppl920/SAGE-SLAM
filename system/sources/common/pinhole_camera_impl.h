 ...
 */
  ...
  inline
      ...
      PinholeCamera<Scalar>::Project(const PointTRef &point) const
  {
  ...
  */
  ...
  inline
      ...
      PinholeCamera<Scalar>::Reproject(const PixelTRef &pixel, const Scalar &depth) const
  {
  ...
  */
  template <typename Scalar>
  inline Eigen::Matrix<Scalar, 3, 2> PinholeCamera<Scalar>::ReprojectPixelJacobian(const PixelTRef &pixel, Scalar depth) const
  {
  ...
  */
  template <typename Scalar>
  inline Eigen::Matrix<Scalar, 3, 1> PinholeCamera<Scalar>::ReprojectDepthJacobian(const PixelTRef &pixel, Scalar depth) const
  {
  ...
  */
  template <typename Scalar>
  inline Eigen::Matrix<Scalar, 2, 3> PinholeCamera<Scalar>::ProjectPointJacobian(const PointTRef &point) const
  {
  ...
  */
  template <typename Scalar>
  template <typename T>
  inline EIGEN_DEVICE_FUNC bool PinholeCamera<Scalar>::PixelValid(T x, T y, long border) const
  {
  ...
  */
  template <typename Scalar>
  inline bool PinholeCamera<Scalar>::PixelValid(const PixelTRef &pixel, long border) const
  {
  ...
  */
  template <typename Scalar>
  template <typename T>
  inline void PinholeCamera<Scalar>::ResizeViewport(const T &new_width, const T &new_height)
  {
  ...
  template <typename Scalar>
  template <typename T>
  inline PinholeCamera<Scalar> PinholeCamera<Scalar>::ComputeResizedCam(const T &new_width, const T &new_height)
  {
    const Scalar x_ratio = new_width / width();
    const Scalar y_ratio = new_height / height();
    return PinholeCamera<Scalar>(fx_ * x_ratio, fy_ * y_ratio, u0_ * x_ratio, v0_ * y_ratio, new_width, new_height);
  }
